...
def generate_butterworth_coeffs(order, fs, low, high, output_dir):
    ...
    # Ensure the directory exists (e.g., results/filter_coeffs)
...
def apply_butterworth_sos(raw_data, order, fs=1000, low=65, high=135, coeffs_dir="../results/filter_coeffs"):
    """Applies Butterworth Bandpass (65-135Hz)."""
    # Now defaults to storing coeffs in the 'results' folder
